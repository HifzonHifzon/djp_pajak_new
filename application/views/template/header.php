  ...
  <title>Sekretariat Pelayanan | Dashboard</title>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url().'asset/datatables/media/css/dataTables.bootstrap.css' ?>">
