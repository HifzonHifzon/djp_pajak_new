       ...
       <div class="row">
          <div class="col-md-6"> 
              <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input type="text" name="nama_petugas" class="form-control" id="nama_petugas" placeholder="Nama Petugas Pelayanan">
                  </div>
              </div> 
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input type="text" name="nip" class="form-control" id="nip" placeholder="Nomor Induk Pegawai (NIP)">
                  </div>
              </div> 
               ...
               <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input type="text" name="no_telp" class="form-control" id="no_telp" placeholder="Nomor Telpon Petugas">
                  </div>
              </div> 
          </div>
          ...
          <div class="col-md-6"> 
            <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input type="text" name="email" class="form-control" id="email" placeholder="Email Petugas">
                  </div>
            </div>
            ...
            <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input type="text" name="alamat" class="form-control" id="alamat" placeholder="Alamat Petugas">
                  </div>
            </div> 
            ...
            <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input type="text" name="username" class="form-control" id="username" placeholder="Username Petugas">
                  </div>
            </div> 
          </div>

          <div class="modal-footer justify-content-between">
             <button type="submit" class="btn btn-primary" onclick="submit_petugas()">Submit</button>
            </div>
  </div>
</div>
</div>
      ...
      <tr>
        ...
        <td class="text-center" width="160px">
          <button class="btn btn-primary btn-xs" data-toggle="modal" onClick="getPetugas(<?php echo $key->id; ?>)" data-target="#edit_petugas">
           ...
           <a onclick ="return deleteData(<?php  echo $key->id ?>)" class="btn btn-danger btn-xs" style="color:white">
